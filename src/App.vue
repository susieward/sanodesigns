  ...
  name: 'App',
    ...
    computed: {
        ...
        notHome(){
            ...
            return this.$store.state.route.name !== 'Home' && this.$store.state.route.name !== 'Designs'  && this.$store.state.route.path !== '/admin'  && this.$store.state.route.path !== '/admin/add'

        },

        typeChosen(){

            return this.$store.state.route.name !== 'Home' && this.$store.state.route.name !== 'Designs' && this.$store.state.route.path !== '/admin'  && this.$store.state.route.path !== '/admin/add' && this.$store.state.route.path !== '/create/type'
        },
