...
data(){
    ...
    methods: {
        ...
        getData: function(){
            ...
            this.$router.push({ name: 'bracelet', sessionId: this.$sessionId, params: { braceletLength: this.braceletLength, braceletSize: this.braceletSize, selectedType: this.selectedType, selectedMaterial: this.selectedMaterial, necklace: this.necklace, bracelet: this.bracelet, selectedClasp: this.selectedClasp}});
        },
